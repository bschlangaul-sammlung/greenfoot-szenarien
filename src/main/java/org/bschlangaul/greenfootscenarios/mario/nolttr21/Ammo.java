...
/**
 * A powerup that, when collected, will turn big mario into marioG and add ammo to the counter.
 * If mario is already marioG or is small mario, it will add ammo to the counter.
 * 
...
public class Ammo extends Powerups
{
    ...
    /**
     * Do something if the ammo Collides with mario, dependent on which type of mario is in the world.
     * If the ammo collides with marioG, add ammunition and play a noise.
     * If the ammo collides with mario, call a method in mario that will turn him into marioG.
     * If the ammo collides with marioS, add ammunition and play a noise.
     */
    ...
    /**
     * This method will move the ammo.
     * If there is a block to the right of the ammo, it will move left until it hits another object.
     * If there is a block to the left of the ammo, it will move left until it hits another object.
     * If there is no object below the ammo, it will fall until there is an object underneath the ammo.
     */
