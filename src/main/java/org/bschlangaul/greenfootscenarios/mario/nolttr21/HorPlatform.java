...
{
    public int horpDelayCount; // ticks up to determine whether or not the platform should turn
                               // around
    ...
    /**
     * Ticks up the turn around delay count and the move delay count, as well as calls the method to
     * move the platform
     */
    public void act()
    {
    ...
    /**
     * This will move the platform left or right dependent on the horpLeft boolean and if the move
     * delay count has ticked up to reach the move delay time yet It will also change the direction
     * of the platform when the horp delay count reaches the horp time
     */
    ...
    /**
     * This will move mario around if he is standing on the platform, based on which direction the
     * platform is moving
     */
