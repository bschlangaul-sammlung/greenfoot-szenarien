...
/**
 * MarioS is the worst version of mario. He is the main actor. If he is hit, he will die and the
 * level will restart with one less life.
 *
...
public class MarioS extends AllMarios
{
    ...
    public boolean marioSetAsSmall = false; // this boolean shows whether or not sWorld has had its
                                            // variables set for mario being small
    public static boolean fell = false; // this boolean determines whether or not mario has fallen
                                        // off of the world
     ...
     * is pressed and there is no block to the left of mario, he will move left. If the s key is
     * pressed and there is a pipe below mario, the world will change.
     */
    ...
    private void animateMario()
    {
        if (Greenfoot.isKeyDown("left"))
        {
            ...
            if (imageDelayCount >= imageTime)// if it's time to change the image
            {
                ...
                setImage(characterName + "marioSL" + imageNumber + ".png");// it looks like we're
                                                                           // walking
