...
{
    public int verpDelayCount; // ticks up to determine whether or not the platform should turn
                               // around
    ...
    /**
     * This will move the platform up or down based on the verpDown boolean If the delay count has
     * reached the delay time, the platform will switch directions
     */
