...
public class Hammer extends NonJump
{
    ...
    private boolean imminentDeath = false; //Defines whether or not the hammer is about to be destroyed
    ...
    /**
     * Defines the left variable for the hammer. Dependent on the creator's hitEdge variable, aka whether or not the creator is moving left or right
     */
    ...
    /**
     * This will move the hammer based on if left is true and the ySpeed of the hammer. (The higher the ySpeed is, the faster the hammer will move down)
     * This will also check if the hammer has collided with any terrain and, if it has, remove the hammer
     */
