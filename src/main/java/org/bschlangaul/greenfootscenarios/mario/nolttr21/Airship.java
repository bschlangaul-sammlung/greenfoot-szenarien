...
public class Airship extends SWorld
{
    ...
    // static GreenfootSound theme = new GreenfootSound("World1 theme.mp3");//I can take care of the
    // music
    ...
    private void buildWorld()
    {
        ...
        if (!flag)
            addObject(new CheckPointD(), 2914, 158);
        else
            addObject(new CheckPointA(), 2914, 158);
