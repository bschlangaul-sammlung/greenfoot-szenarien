...
public class jFireball extends NonJump
{
    ...
    /**
     * This will tick up the ySpeed and jDelayCount for the fireball movement. It will also call the
     * method for the fireball to jump This will move the fireball if it is in the screen in the Y
     * direction
     */
    public void act()
    {
