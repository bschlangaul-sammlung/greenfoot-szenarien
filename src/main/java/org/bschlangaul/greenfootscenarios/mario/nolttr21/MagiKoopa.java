...
public class MagiKoopa extends MovingEnemies
{
    ...
    /**
     * This will call the appropriate methods to run the MagiKoopa, as well as tick up the delayCount
     */
    public void act() 
    {
        if (moveable)
    ...
    /**
     * This will move the MagiKoopa based on whether or not it has hit an object and switch the image according to which direction it is moving
     */
    ...
    /**
     * This method is called by mario's bullet when it collides with the MagiKoopa. It will subtract the bullet's damage from the stability of the MagiKoopa.
     * If the stability is less than or equal to 0, the MagiKoopa will be removed
     */
    ...
    /**
     * This will shoot a fireball if the fireDelayCount passes the fireDelayTime. It will spawn the fireball at the MagiKoopa's location
     */
    private void fire()
    {
