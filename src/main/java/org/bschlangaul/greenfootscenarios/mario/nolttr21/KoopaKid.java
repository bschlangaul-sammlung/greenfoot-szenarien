...
public class KoopaKid extends MovingEnemies
{
    ...
    private int fireDelayTime; //The time that the delaycount must pass before the KoopaKid shoots a shell
    ...
    private int imageChangeTime = 8; //This is the number the delay count must pass to switch the image
    ...
    /**
     * This method is called by mario's bullet when it collides with the KoopaKid. It will subtract the bullet's damage from the stability of the KoopaKid.
     * If the stability is less than or equal to 0, the KoopaKid will be removed
     */
    ...
    /**
     * This will animate the koopakid based on which direction it is moving and whether or not the imageChangeDelayCount has reached the imageChangeTime
     */
    ...
    /**
     * KoopaKid will throw a shell if the fireDelayCount passes the fireDelayTime. It will spawn the fireball at the KoopaKid's location
     */
    private void fire()
    {
