...
public class Map extends SWorld
{
    ...
    private void prepare()
    {
        switch (at)
        {
            case 1: addObject(new MapMario(),193,45);break;
            case 2: addObject(new MapMario(),362,45);break;
            case 3: addObject(new MapMario(),195,211);break;
            case 4: addObject(new MapMario(),527,378);break;
            case 5: addObject(new MapMario(),665,45);break;
            default:MapMario mapmario = new MapMario();
            addObject(mapmario,28,45);
            mapmario.setLocation(25,40);break;
        }
