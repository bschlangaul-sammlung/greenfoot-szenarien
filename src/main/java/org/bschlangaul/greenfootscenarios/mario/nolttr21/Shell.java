...
public class Shell extends Jump
{
    ...
    /**
     * Defines the left variable based on the creator's hitEdge variable
     * Also defines the death delay time
     */
    ...
    /**
     * Calls the method to move and remove the shell and ticks up the delay counter for the death of the shell
     */
    public void act() 
    {
        deathDelayCount ++;
    ...
    /**
     * This method will move the shell.
     * If there is a block to the right of the shell, it will move left until it hits another object.
     * If there is a block to the left of the shell, it will move left until it hits another object.
     * If there is no object below the shell, it will fall until there is an object underneath the shell.
     */
