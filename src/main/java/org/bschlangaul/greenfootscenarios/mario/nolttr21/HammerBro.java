...
public class HammerBro extends MovingEnemies
{
    ...
    private int fireDelayTime; //The time that the delaycount must pass before the HammerBro throws a hammer
    ...
    private int imageChangeTime = 5; //This is the number the delay count must pass to switch the image
    ...
    /**
     * This will call the appropriate methods to run the HammerBro, as well as tick up the delayCount for firing and switching the image
     */
    public void act() 
    {
    ...
    /**
     * This will animate the hammerbro based on which direction it is moving and whether or not the imageChangeDelayCount has reached the imageChangeTime
     */
    ...
    /**
     * This method is called by mario's bullet when it collides with the HammerBro. It will subtract the bullet's damage from the stability of the HammerBro.
     * If the stability is less than or equal to 0, the HammerBro will be removed
     */
    ...
    /**
     * HammerBro will throw a hammer if the fireDelayCount passes the fireDelayTime. It will spawn the fireball at the HammerBro's location
     */
    private void fire()
    {
