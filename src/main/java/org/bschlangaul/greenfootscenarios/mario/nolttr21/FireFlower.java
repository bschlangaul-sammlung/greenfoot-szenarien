...
public class FireFlower extends NonJumpable
{
    ...
    private int fireDelayTime; //The time that the delaycount must pass before the fireflower shoots
    ...
    /**
     * This will call the appropriate methods to run the fireflower, as well as tick up the delayCount
     */
    public void act() 
    {
        fireDelayCount ++;
    ...
    /**
     * This method is called by mario's bullet when it collides with the fireflower. It will subtract the bullet's damage from the stability of the fireflower.
     * If the stability is less than or equal to 0, the fireflower will be removed
     */
    ...
    /**
     * This will turn the fireflower depending on where mario is relative to the fireflower.
     * The larger if statements prevent null pointer exceptions by first checking which mario is in the world
     */
    ...
    /**
     * This will shoot a fireball if the fireDelayCount passes the fireDelayTime. It will spawn the fireball at the FireFlower's location
     */
    private void fire()
    {
        if (fLeft == true)
