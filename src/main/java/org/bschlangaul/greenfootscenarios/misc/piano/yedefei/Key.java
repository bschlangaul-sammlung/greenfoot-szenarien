...
public class Key extends Actor
{
    ...
    public void mouseClickedEvent(){
        ...
        if(mouseInfo!=null){
            if(!isPressed && Greenfoot.mousePressed(this) && getX()+19>mouseInfo.getX() && getX()-19<mouseInfo.getX() && getY()+138>mouseInfo.getY() && getY()+26<mouseInfo.getY() && keyType=="white"&& mouseInfo.getButton() == 1 ){
                Greenfoot.playSound(scale+ "/" + soundName+".mp3");
                setImage(mouseDownImage);
                isPressed = true;
                NoteRainGenerate("start");
            }else if(!isPressed && Greenfoot.mousePressed(this) && getX()+13>mouseInfo.getX() && getX()-13<mouseInfo.getX() && getY()+82>mouseInfo.getY() && getY()-82<mouseInfo.getY() && keyType=="black"&& mouseInfo.getButton() == 1 ){
                Greenfoot.playSound(scale+ "/" + soundName+".mp3");
                setImage(mouseDownImage);
                isPressed = true;
                NoteRainGenerate("start");
    ...
    public void mouseHoverEvent(){
        ...
        if(mouseInfo!=null && !isPressed && !isDown && !isDragged){
            if(getX()+19>mouseInfo.getX() && getX()-19<mouseInfo.getX() && getY()+138>mouseInfo.getY() && getY()+26<mouseInfo.getY() && keyType=="white"){
                setImage(hoverImage);
                isHover = true;
            }else if(getX()+13>mouseInfo.getX() && getX()-13<mouseInfo.getX() && getY()+82>mouseInfo.getY() && getY()-82<mouseInfo.getY() && keyType=="black"){
                setImage(hoverImage);
                isHover = true;
            }else{
                if(isHover){
    ...
    public void mouseDraggedEvent(){
        MouseInfo mouseInfo = Greenfoot.getMouseInfo();
        if(mouseInfo!=null){
            if(getX()+19>mouseInfo.getX() && getX()-19<mouseInfo.getX() && getY()+138>mouseInfo.getY() && getY()+26<mouseInfo.getY() && keyType=="white" && mouseInfo.getButton() == 1 && !Greenfoot.mouseClicked(this)){
                Greenfoot.playSound(scale+ "/" + soundName+".mp3");
                setImage(mouseDownImage);
                isDragged = true;
                NoteRainGenerate("start");
            }
            if(getX()+13>mouseInfo.getX() && getX()-13<mouseInfo.getX() && getY()+82>mouseInfo.getY() && getY()-82<mouseInfo.getY() && keyType=="black" && mouseInfo.getButton() == 1 && !Greenfoot.mouseClicked(this)){
                Greenfoot.playSound(scale+ "/" + soundName+".mp3");
                setImage(mouseDownImage);
                isDragged = true;
                NoteRainGenerate("start");
            }
            if(isDragged && (getX()+19<mouseInfo.getX() || getX()-19>mouseInfo.getX() || getY()+138<mouseInfo.getY() || getY()+26>mouseInfo.getY())){
                setImage(Image);
                isDragged = false;
                NoteRainGenerate("stop");
            }
