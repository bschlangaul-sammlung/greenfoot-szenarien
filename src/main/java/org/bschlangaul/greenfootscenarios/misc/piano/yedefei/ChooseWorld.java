...
public class ChooseWorld extends World
{
     ...
     *
     */
    private MusicText[] musicArr = {new MusicText("�ɶ�"),new MusicText("����"),new MusicText("�������"),new MusicText("�մ��ɵ�����"),new MusicText("���޵��ǿ�����"),new MusicText("��ɫ��觺�"),new MusicText("���еĻ���"),new MusicText("ƽ��֮·"),new MusicText("ʮ��"),new MusicText("˵�ò���")};
